...
typedef struct led_ops {
    ...
    int (*enable)(led_dev_t *dev, led_channel_t chn);                                 /** enable led, device must have this api */
    int (*disable)(led_dev_t *dev, led_channel_t chn);                                /** disable led, device must have this api */
    int (*get_current_range)(led_dev_t *dev, led_channel_t chn, float *min, float *max, float *step);    /** get min/max/step, set to NULL if not support */
    int (*set_current)(led_dev_t *dev, led_channel_t chn, float current_ma);          /** set led current, set to NULL if not support */
    int (*set_timeout)(led_dev_t *dev, led_channel_t chn, int timeout_ms);            /** set led timtout, led will auto stop work after timeout untill next trigger, set to NULL if not support */
    int (*trigger)(led_dev_t *dev, led_channel_t chn);                                /** trigger led to make it work again, device must have this api */
    int (*suspend)(led_dev_t *dev, led_channel_t chn);                                /** suspend led, led will not work until resume, device must have this api */
    int (*resume)(led_dev_t *dev, led_channel_t chn);                                 /** resume led, device must have this api */
} led_ops_t;
...
typedef struct led_dev {
    ...
    int is_enable[CHANNEL_ALL];   /** is this led device enabled */
    int is_suspend[CHANNEL_ALL];               /** is this led suspended */
    int timeout_ms[CHANNEL_ALL];               /** timeout in milisecond of this led device */
#ifdef USE_RTOS
 ...
 * @return int, 0 for success and other for fail
 */
int led_enable(led_dev_t *dev, led_channel_t chn);
 ...
 * @return int, 0 for success and other for fail
 */
int led_disable(led_dev_t *dev, led_channel_t chn);
 ...
 * @return int, 0 for success and other for fail
 */
int led_get_current_range(led_dev_t *dev, led_channel_t chn, float *current_min, float *current_max, float *current_step);
 ...
 */
int led_set_current(led_dev_t *dev, led_channel_t chn, float current_ma);
 ...
 */
int led_set_current_level(led_dev_t *dev, led_channel_t chn, led_current_level_t current_level);
 ...
 * @sa #led_trigger
 */
int led_set_timeout(led_dev_t *dev, led_channel_t chn, int timeout_ms);
 ...
 * @sa #led_set_timeout
 */
int led_trigger(led_dev_t *dev, led_channel_t chn);
 ...
 * @sa #led_resume
 */
int led_suspend(led_dev_t *dev, led_channel_t chn);
 ...
 * @sa led_suspend
 */
int led_resume(led_dev_t *dev, led_channel_t chn);
